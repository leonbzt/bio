...
- **Delivery**: one PNG per (kingdom, density) variant. Filenames: `<kingdom_id>_pioneer.png`, `<kingdom_id>_establishing.png`, `<kingdom_id>_established.png`, `<kingdom_id>_mature.png`. Drop into `assets/art/kingdoms/clusters/`.
